<?php
// Confirmation screen shared by "added to cart" and "added to wishlist".
// Required variables: $heading, $target_url, $target_label.
...
<div class="message-box">
  <h2>🛍️ <?= htmlspecialchars($heading) ?>!</h2>
  <p><?= htmlspecialchars($product_name) ?></p>
  <button onclick="window.location.href='shop.php'">Continue Shopping</button>
  <button onclick="window.location.href='<?= $target_url ?>'"><?= htmlspecialchars($target_label) ?></button>
</div>
